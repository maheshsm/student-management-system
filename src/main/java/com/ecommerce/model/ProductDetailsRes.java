...
public class ProductDetailsRes {
	...
	public String toString() {
		return "ProductDetailsRes [productId=" + productId + ", name=" + name + ", pricePerQuantity=" + pricePerQuantity
				+ ", pricePerKg=" + pricePerKg + ", pricePerLtr=" + pricePerLtr + ", totalQuantity=" + totalQuantity
				+ ", totalKg=" + totalKg + ", totalLtr=" + totalLtr + ", totalPrice=" + totalPrice + ", isWarranty="
				+ isWarranty + ", warrantyDate=" + warrantyDate + ", isGuarantee=" + isGuarantee + ", guaranteeDate="
				+ guaranteeDate + ", sgst=" + sgst + ", cgst=" + cgst + ", categoryName=" + categoryName
				+ ", discountName=" + discountName + ", discountType=" + discountType + ", discountValue="
				+ discountValue + "]";
	}
}